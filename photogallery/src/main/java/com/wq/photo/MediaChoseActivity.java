...
//        Log.e("media","mediachooseActivity:拍照返回结果2222222");
        Log.e("requestcode",requestCode+"uuu");
        Log.e("resultok",RESULT_OK+"uuu");
        Log.e("ucorp",UCrop.REQUEST_CROP+"uuu");
        Log.e("camera",REQUEST_CODE_CAMERA+"uuu");
        if (resultCode == RESULT_OK && requestCode == UCrop.REQUEST_CROP) {
            Log.e("-----","mediachooseActivity:拍照返回结果2222222");
            ...
            Log.e("-----","mediachooseActivity:拍照返回结果");
            ...
            Log.e("-----","mediachooseActivity:拍照返回结果11111");
            if (currentfile != null && currentfile.exists() && currentfile.length() > 10) {
                getImageChoseMap().put(currentfile.getAbsolutePath(), currentfile.getAbsolutePath());
                invalidateOptionsMenu();
                insertImage(currentfile.getAbsolutePath());
...
//        intent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(currentfile));
        Uri uri = FileProvider.getUriForFile(this,"com.bohui.fileprovider",currentfile);
