...
public class TestActivity extends Activity implements AMap.OnMapLoadedListener, AMap.OnMapClickListener, LocationSource, AMapLocationListener {
    private AMap aMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.maptest_layout);
        /*
...
//        aMap.setMyLocationType(AMap.LOCATION_TYPE_LOCATE);
    ...
    private void addLocationMarker1() {
        LatLng mylocation = new LatLng(31.044252, 121.252102);
        aMap.animateCamera( CameraUpdateFactory.newLatLngZoom(mylocation, 16), 300, null);
        float accuracy = 50;
        if (locMarker == null) {
            locMarker = addMarker(mylocation);
            ac = aMap.addCircle(new CircleOptions().center(mylocation)
