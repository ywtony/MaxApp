...
public class TagAliasUtil {
    ...
    private static TagAliasUtil mInstance;

    private TagAliasUtil() {
    }

    public static TagAliasUtil getInstance() {
        if (mInstance == null) {
            synchronized (TagAliasUtil.class) {
                if (mInstance == null) {
                    mInstance = new TagAliasUtil();
                }
            }
        }
        return mInstance;
