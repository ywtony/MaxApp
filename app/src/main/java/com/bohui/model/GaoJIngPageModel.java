 ...
 *
 */
public class GaoJIngPageModel implements IBaseModel {
    /**
     * 点击告警定位按钮所触发的函数
     *
     * @param context
     ...
     * @param iGaoJingView
     */
    public void getGaoJingPage(Context context, String sessionId, String moID, final IGaoJingView iGaoJingView) {
        try {
            ...
            parameters.add(new BasicNameValuePair("type", "searchPageBoxsByMeasObjID"));
            parameters.add(new BasicNameValuePair("moID", moID));//当前页
