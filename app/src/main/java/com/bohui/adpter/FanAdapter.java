...
public class FanAdapter extends CommonAdapter {
    private Context context;
    public FanAdapter(Context mContext, List<FanEntity> list, int layoutId){
    ...
    public void convert(ViewHolder holder, Object o, int position) {
       final FanEntity entity=(FanEntity)o;
        (holder.getView(R.id.rl_temperature)).setBackgroundResource(R.drawable.blues);
        (holder.getView(R.id.iv_temperature)).setBackgroundResource(R.drawable.fan);
        ...
        temperature.setText(entity.getFanName());
        ...
        rl_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ToastUtils.show(context,entity.getFanName());
            }
        });
