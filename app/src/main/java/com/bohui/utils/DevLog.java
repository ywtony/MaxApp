 ...
 * <b>使用方法:</b>
 * <p>
 * 1.<b>display</b>�?<b>true</b>时打印日志信息，发布应用时应�?<b>display</b>设置�?<b>false</b >
 * <p>
 * 2. 分别使用DevLog.v() DevLog.d() DevLog.i() DevLog.w() DevLog.e()打印不同级别的错�?
 * <p>
 * <b>注：</b>推荐使用{@link
 * �?<b>isDevLogDisplayOn<b>为false禁用Log输出�?
 * 
...
public class DevLog {
	 ...
	 * 
	 * @param tag
	 *            标识日志信息的来源，�?般为打印日志的Class或�?�Activity名�??
	 * @param msg
	 *            要输出的日志信息
	 */
	 ...
	 * 
	 * @param obj
	 *            标识日志信息的来源，自动获得obj的Class名作为日志来源的标识。一般传�?<b>this</b>即可�?
	 * @param msg
	 *            要输出的日志信息
	 */
