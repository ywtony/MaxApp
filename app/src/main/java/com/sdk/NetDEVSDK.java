...
public class NetDEVSDK {
    ...
    */
	...
	public static native int NETDEV_GetSystemTimeCfg(long lpUserID, NETDEV_TIME_S stDeviceTime);
	 ...
	 * @return
	 */
	public static native int NETDEV_SetSystemTimeCfg(long lpUserID, NETDEV_TIME_S stDeviceTime);
